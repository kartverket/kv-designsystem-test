...
```tsx
<Checkbox label='Stedsnavn' {...getCheckboxProps('stedsnavn')} />;
// eller
<Checkbox label='Stedsnavn' {...getCheckboxProps({ value: 'stedsnavn' /* ...and other props... */ })} />;
```
...
return (
  <Fieldset>
    ...
    />
    <Checkbox label='Eiendom' {...getCheckboxProps('eiendom')} />
    <Checkbox label='Kart og stedsnavn' {...getCheckboxProps('kart')} />
    <Checkbox label='Matrikkel' {...getCheckboxProps('matrikkel')} />
    <Checkbox label='Geodata' {...getCheckboxProps('geodata')} />
