...
- du skal gjøre brukeren oppmerksom på feil i enkeltfelt, bruk heller komponentens egen feilmelding [`ValidationMessage`](/docs/components-typography--docs)
...
Hvis meldingen er lenger enn en setning kan det være nyttig å bruke en overskrift til å fremheve det viktigste. Dette kan gjøres med [`Heading`](/docs/components-typography--docs). Husk å velge riktig overskriftsnivå ut fra plassen `Alert` har i innholdsstrukturen på siden
