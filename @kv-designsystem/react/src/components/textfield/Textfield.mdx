...
- brukeren skal velge fra et begrenset sett med alternativer – bruk heller [`Radio`](/docs/components-radio--docs), [`Checkbox`](/docs/components-checkbox--docs), [`Select`](/docs/components-select--docs) eller [`Suggestion`](/docs/components-suggestion--docs)
...
**OBS:** Ikke bruk stjerne (`*`) for å markere felt som må fylles ut.

<Canvas of={TextfieldStories.Required} />

{/* TODO: add do-dont that shows not to use asterisks (*) */}
